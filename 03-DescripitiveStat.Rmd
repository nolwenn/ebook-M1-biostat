...
```{r histogram,  fig.cap='Distrubution of weights (Kg) of 11 to 16 years-old students, in France in 2006', out.width='70%', fig.asp=.75, echo=FALSE, message=FALSE, warning=FALSE}
library(ggplot2)
